    ...
    return (<Button
        ...
        >
            ...
            <OptionsContainer
                ...
                animate={isOpen ? {
                    height: "auto", opacity: 1, boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.25)"
                } : {
                    height: 0, opacity: 0, boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.1)"
                }}
                transition={{type: "spring", stiffness: 300}}
            >
                {subItems.map((subItem, index) => (<Option key={index} whileHover={{backgroundColor: "#f0f0f0"}}>
